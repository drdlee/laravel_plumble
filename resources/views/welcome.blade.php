...
<div class="content-wrapper">
    ...
    <div class="container">
            ...
            <div class="col-lg-8">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <img src="{{ $latestPost->featured}}" alt="{{ $latestPost->title }}">
                            <div class="overlay"></div>
                            <a href="{{ $latestPost->featured}}" class="link-image js-zoom-image">
        ...
        <div class="row">
          ...
          @foreach ($latestPost2 as $latest2)
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">

                        <div class="post-thumb">
                            <img src="{{ $latest2->featured }}" alt="seo">
                            <div class="overlay"></div>
                            <a href="{{ $latest2->featured }}" class="link-image js-zoom-image">
                                <i class="seoicon-zoom"></i>
                            </a>
                            <a href="#" class="link-post">
                                <i class="seoicon-link-bold"></i>
                            ...
                            <div class="post__content-info">
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="post__date">
                                            ...
                                            <time class="published" datetime="2016-04-17 12:00:00">
                                                {{ $latest2->created_at->toFormattedDateString() }}
                                            </time>
                ...
                <div class="offers">
                    ...
                    <div class="row">
                        <div class="case-item-wrap">
                          ...
                          @foreach ($section1content as $post)
                ...
                <div class="offers">
                    ...
                    <div class="row">
                        <div class="case-item-wrap">
                          ...
                          @foreach ($section2content as $post)
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <div class="case-item">
                                    <div class="case-item__thumb">
                                        <img src="{{ $post->featured}}" alt="{{ $post->title }}">
